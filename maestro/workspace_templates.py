...
def render_workspace_awareness_md(
    *,
    ...
    lines = [
        ...
        "Use this file as source of truth when answering model, network, and access-link questions.",
        "",
...
def render_tools_md(company_name: str, active_provider_env_key: str | None = None) -> str:
    ...
    return (
        ...
        "2. Treat `AWARENESS.md` as the source of truth for live URLs, model, and store facts.\n"
        "3. Use this file for tool semantics and command choice.\n"
        "4. Use `SOUL.md` for role and boundary interpretation, not for live runtime facts.\n"
        "5. If files disagree, prefer the most specific operational file over general prose.\n\n"
        "## What You Do\n"
        ...
        "- Do not ask for information already available in `AWARENESS.md`, registry state, or live fleet context.\n\n"
        "## Worked Examples\n"
...
def render_company_agents_md() -> str:
    ...
    return (
        ...
        "2. Identify the source of truth needed for the answer: `AWARENESS.md`, live fleet context, registry/runtime state, or project-maestro reply.\n"
