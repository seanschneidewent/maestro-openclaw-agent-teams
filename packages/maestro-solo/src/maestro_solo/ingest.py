...
Usage (CLI):
    maestro-solo ingest <path-to-pdf-folder> [--project-name "My Project"] [--dpi 200]

Usage (Python):
    from maestro_solo.ingest import ingest
...
from maestro_engine.config import (
    DEFAULT_DPI,
...
from maestro_engine.utils import (
    bbox_to_region_id,
    collect_response,
    crop_region,
    load_json,
...
from maestro_engine.index import build_index
...
def ingest(
    ...
    if license_key and license_key.startswith("MAESTRO-PROJECT-"):
        ...
        try:
            ...
            from maestro_engine.utils import slugify_underscore
