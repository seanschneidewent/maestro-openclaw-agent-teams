...
curl -fsSL "$BASE_INSTALL_URL" | MAESTRO_INSTALL_AUTO="${MAESTRO_INSTALL_AUTO:-1}" MAESTRO_INSTALL_FLOW=free MAESTRO_INSTALL_CHANNEL="${MAESTRO_INSTALL_CHANNEL:-core}" bash
